...
jaaspeel.ad_url = escape(location.protocol + '//' + location.host +'/advert');

jaaspeel.small_path = location.protocol + '//' + location.host +'/assets/js/small.swf';
jaaspeel.small_image = escape(location.protocol + '//' + location.host +'/uploads/corner_advert/large.jpg');
jaaspeel.small_width = '100';
jaaspeel.small_height = '100';
jaaspeel.small_params = 'ico=' + jaaspeel.small_image;

jaaspeel.big_path = location.protocol + '//' + location.host +'/assets/js/large.swf';
jaaspeel.big_image = escape(location.protocol + '//' + location.host +'/uploads/corner_advert/large.jpg');
