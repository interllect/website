<?php
include_once(base_url()."assets/wdCalendar/php/dbconfig.php");
include_once(base_url()."assets/wdCalendar/php/functions.php");
...
<html xmlns="http://www.w3.org/1999/xhtml" >
  <head>    
    ...
    <link href="<?php echo base_url();?>assets/wdCalendar/css/main.css" rel="stylesheet" type="text/css" />       
    <link href="<?php echo base_url();?>assets/wdCalendar/css/dp.css" rel="stylesheet" />    
    <link href="<?php echo base_url();?>assets/wdCalendar/css/dropdown.css" rel="stylesheet" />    
    <link href="<?php echo base_url();?>assets/wdCalendar/css/colorselect.css" rel="stylesheet" />   
     
    <script src="<?php echo base_url();?>assets/wdCalendar/src/jquery.js" type="text/javascript"></script>    
    <script src="<?php echo base_url();?>assets/wdCalendar/src/Plugins/Common.js" type="text/javascript"></script>        
    <script src="<?php echo base_url();?>assets/wdCalendar/src/Plugins/jquery.form.js" type="text/javascript"></script>     
    <script src="<?php echo base_url();?>assets/wdCalendar/src/Plugins/jquery.validate.js" type="text/javascript"></script>     
    <script src="<?php echo base_url();?>assets/wdCalendar/src/Plugins/datepicker_lang_US.js" type="text/javascript"></script>        
    <script src="<?php echo base_url();?>assets/wdCalendar/src/Plugins/jquery.datepicker.js" type="text/javascript"></script>     
    <script src="<?php echo base_url();?>assets/wdCalendar/src/Plugins/jquery.dropdown.js" type="text/javascript"></script>     
    <script src="<?php echo base_url();?>assets/wdCalendar/src/Plugins/jquery.colorselect.js" type="text/javascript"></script>    
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            //debugger;
            var DATA_FEED_URL = "<?php echo base_url();?>assets/wdCalendar/php/datafeed.db.php";
            var arrT = [];
            var tt = "{0}:{1}";
            for (var i = 0; i < 24; i++) {
  ...
  <body>    
    <div>      
      ...
      <div class="infocontainer">            
        <form action="<?php echo base_url();?>assets/wdCalendar/php/datafeed.php?method=adddetails<?php echo isset($event)?"&id=".$event->Id:""; ?>" class="fform" id="fmEdit" method="post">                 
          <label>                    
            <span>                        *Subject:              
            </span>                    
